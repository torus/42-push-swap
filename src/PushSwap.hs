...
([3,4,2,1] [5,7,6,8,9,0],["rb","pb","rb","pb","rb","pb","rb","pb","ra","pa","pa","pa","rb","pa","pa","rb"])
>>> spPartitionIterLeft (makeStackPair' [3,4,2,1] [5,7,6,8,9,0], [])
([4,3,2] [5,7,6,8,9,0,1],["rb","pb","rb","pb","rb","pb","ra","pa","pa","rb","pa","pa","rb","rb"])
>>> spPartitionIterLeft (makeStackPair' [4,3,2] [5,7,6,8,9,0,1], [])
([4,3] [5,7,6,8,9,0,1,2],["rb","pb","rb","pb","ra","pa","pa","rb","pa","rb","rb"])
>>> spPartitionIterLeft (makeStackPair' [4,3] [5,7,6,8,9,0,1,2], [])
([4] [5,7,6,8,9,0,1,2,3],["rb","pb","ra","pa","pa","rb"])
